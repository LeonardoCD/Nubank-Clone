...
import 'package:nubanckClone/pages/home/widgets/bottom_menu/item_menu_bottom.dart';

class BottonMenu extends StatefulWidget {
  final bool showMenu;

  const BottonMenu({Key key, this.showMenu}) : super(key: key);

  @override
  _BottonMenuState createState() => _BottonMenuState();
}
